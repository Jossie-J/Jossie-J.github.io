...
* Go to the [commit list](https://github.com/Jossie-J/Jossie-J.github.io/commits/master) (on your repo) to find the last version GitHub built with Jekyll. 
 ...
 * The [Liquid syntax guide](https://shopify.github.io/liquid/tags/control-flow/) is a useful guide for those that want to add functionality to the template or to become contributors to the [template on GitHub](https://github.com/Jossie-J/Jossie-J.github.io).
